...
var GitHubButton = function (_React$Component) {
  ...
  GitHubButton.prototype.getText = function getText(type) {
    switch (type) {
      case 'follow':
  ...
  GitHubButton.prototype.render = function render() {
    var _props4 = this.props,
        ...
        type = _props4.type,
        size = _props4.size,
        ariaLabel = _props4.ariaLabel,
        repo = _props4.repo,
        rest = _objectWithoutProperties(_props4, ['className', 'type', 'size', 'ariaLabel', 'repo']);
    ...
    var ghCount = repo ? _react2["default"].createElement(
      'a',
    ...
    return _react2["default"].createElement(
      ...
      _react2["default"].createElement(
        'a',
        { 'aria-label': ariaLabel, className: 'gh-btn', href: this.getRepoUrl(), target: '_blank' },
...
GitHubButton.propTypes = {
  ...
  type: _propTypes2["default"].oneOf(['stargazers', 'watchers', 'forks', 'follow']).isRequired,
